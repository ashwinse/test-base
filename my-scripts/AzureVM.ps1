...
$pip = New-AzureRmPublicIpAddress -Name $pipName -AllocationMethod Dynamic -DomainNameLabel $dnsPrefix -Location $rgLocation -ResourceGroupName $rgName
...
$nic = New-AzureRmNetworkInterface -Name $nicName -Location $rgLocation -SubnetId $vnet.Subnets[0].Id -PublicIpAddressId $pip.Id -NetworkSecurityGroupId $nsg.Id -IpConfigurationName 'ipconfif1' -ResourceGroupName $rgName
...
$osDiskName = 'sys-' + $uniqueString + 'OsDisk'
