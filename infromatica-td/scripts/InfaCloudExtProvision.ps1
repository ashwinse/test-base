param([string]$cloudUsername, [string]$cloudEmail, [securestring]$cloudPassword, [string]$firstName, [string]$lastName, [string]$title, [string]$orgName, [string]$phone, [string]$country, [string]$state, [string]$connectorUUIDs)
